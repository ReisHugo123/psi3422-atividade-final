...
/* ---- labirinto ---- */
#define DIST_PARE_MM     250   /* parede a menos que isso e bloqueio */
#define PASSO_MM         200   /* avanco entre duas leituras do sonar */
#define RECUO_MM          80   /* recua antes de girar, para nao raspar */
